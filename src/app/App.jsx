...
class App extends React.Component {
  ...
  getFloodData() {
    Promise.all([
      ...
      Promise.all(mqttFloodData && mqttFloodData.length && mqttFloodData.map(async (flood) => {
  ...
  getSensorData() {
    Promise.all([
      ...
      Promise.all(mqttSensorData && mqttSensorData.length && mqttSensorData.map(async (sensor) => {
